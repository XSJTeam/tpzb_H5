...
export default class myUtils {
	...
	static getFullPathById(id) {
		return store.state.baseURL + '/viewImage?id=' + id;
	}
	...
	static hiddenString(str, before, after, length) {
		if (!str) return str;
		str = str + "";
		var l = length || 4;
		var s = "";
		...
		return str.substring(0, before) + s + str.substring(str.length - after);
	}
